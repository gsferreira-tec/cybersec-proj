...
\begin{frame}[fragile]{Where Misconfigurations Appear}
  ...
  \begin{columns}[T]
    \column{0.40\textwidth}
      ...
      \begin{itemize}
        \item \hspace{-20pt} SPF: \verb|v=spf1 mx ~all| (soft-fail, accepts suspicious senders).
        \item \hspace{-20pt} DKIM: selector not published or key mismatch.
        \item \hspace{-20pt} DMARC: \\ \texttt{v=DMARC1; p=none; aspf=r; adkim=r} (monitoring only, relaxed alignment).
      \end{itemize}
      \end{block}
...
\begin{frame}[fragile]{Infrastructure Hardening}
  ...
  \begin{columns}[T]
    \column{0.40\textwidth}
      ...
      \begin{figure}[H]
      	\centering
      	\includegraphics[width=\textwidth]{testcase_images/2nd-testcase-spfsoft.png}
      \end{figure}
    \column{0.59\textwidth}
     \vspace{-5pt}
	  \begin{figure}[H]
      	\centering
      	\includegraphics[width=0.85\textwidth, height=5.5cm]{testcase_images/3rd-testcase-spfhard.png}
      \end{figure}
      \vspace{-10pt}
