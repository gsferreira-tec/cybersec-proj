...
\begin{frame}[fragile]{Development Highlights: \texttt{spoofmaster}}
  \begin{itemize}
...
\begin{frame}{Where Misconfigurations Appear}
  \begin{columns}[T]
    \column{0.55\textwidth}
      \textbf{Examples from the Lab}
      \begin{itemize}
    ...
    \column{0.45\textwidth}
      \centering
      {\small[Diagram: DNS records vs. MTA configuration vs. headers]}
  \end{columns}
\end{frame}
...
\begin{frame}{SPF-Based Spoofing Scenario}
  \textbf{Attack Setup}
  \begin{itemize}
...
\begin{frame}{Infrastructure Hardening}
  \begin{columns}[T]
    \column{0.5\textwidth}
      \textbf{Before (Vulnerable)}
      \begin{itemize}
...
\begin{frame}{Experimental Results}
  \textbf{Spoofing Success vs. Configuration}
  \begin{itemize}
